...
* Mapear completamente Torreón en [OpenStreetMap](openstreetmap.org).
* Mapear completamente cada uno de los municipios de La Comarca Lagunera en [OpenStreetMap](openstreetmap.org).
